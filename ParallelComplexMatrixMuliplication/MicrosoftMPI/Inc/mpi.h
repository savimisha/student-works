...
MPI_Type_indexed(
    int count,
    _In_count_(count) const int array_of_blocklengths[],
    _In_count_(count) const int array_of_displacements[],
    MPI_Datatype oldtype,
    _Out_ MPI_Datatype* newtype
    );
int
...
MPI_Type_create_hindexed(
    int count,
    _In_count_(count) const int array_of_blocklengths[],
    _In_count_(count) const MPI_Aint array_of_displacements[],
    MPI_Datatype oldtype,
    _Out_ MPI_Datatype* newtype
    );
int
...
PMPI_Type_create_hindexed(
    int count,
    _In_count_(count) const int array_of_blocklengths[],
    _In_opt_count_(count) const MPI_Aint array_of_displacements[],
    MPI_Datatype oldtype,
    _Out_ MPI_Datatype* newtype
    );
...
MPI_Type_create_struct(
    ...
    _In_count_(count) const int array_of_blocklengths[],
    _In_count_(count) const MPI_Aint array_of_displacements[],
    _In_count_(count) const MPI_Datatype array_of_types[],
    _Out_ MPI_Datatype* newtype
    );
int
MPIAPI
...
MPI_Type_create_subarray(
    int ndims,
    _In_count_(ndims) const int array_of_sizes[],
    _In_count_(ndims) const int array_of_subsizes[],
    _In_count_(ndims) const int array_of_starts[],
    int order,
    MPI_Datatype oldtype,
    _Out_ MPI_Datatype* newtype
    );
...
MPI_Type_create_darray(
    ...
    int rank,
    int ndims,
    _In_count_(ndims) const int array_of_gszies[],
    _In_count_(ndims) const int array_of_distribs[],
    _In_count_(ndims) const int array_of_dargs[],
    _In_count_(ndims) const int array_of_psizes[],
    int order,
    MPI_Datatype oldtype,
    _Out_ MPI_Datatype* newtype
    );
...
MPIAPI
MPI_Unpack(
    _In_bytecount_(insize) const void* inbuf,
    int insize,
    _Inout_ int* position,
    _Out_ void* outbuf,
    int outcount,
...
MPI_Alltoallw(
    ...
    _In_ const int sendcounts[],
    _In_ const int sdispls[],
    _In_ const MPI_Datatype sendtypes[],
    _Out_ void* recvbuf,
    _In_ const int recvcounts[],
    _In_ const int rdispls[],
...
MPI_Group_translate_ranks(
    MPI_Group group1,
    int n,
    _In_count_(n) const int ranks1[],
    MPI_Group group2,
    _Out_cap_(n) int ranks2[]
    );
int
MPIAPI
...
MPI_Cart_create(
    MPI_Comm comm_old,
    int ndims,
    _In_count_(ndims) const int dims[],
    _In_count_(ndims) const int periods[],
    int reorder,
...
MPI_Graph_create(
    MPI_Comm comm_old,
    int nnodes,
    _In_count_(nnodes) const int index[],
    _In_ const int edges[],
    int reorder,
    _Out_ MPI_Comm* comm_cart
    );
int
...
MPI_Comm_spawn_multiple(
    ...
    _In_count_(count) const int array_of_maxprocs[],
    _In_count_(count) const MPI_Info array_of_info[],
    int root,
    MPI_Comm comm,
    _Out_ MPI_Comm* intercomm,
